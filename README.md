...
This repository contains a collection of projects I built while learning frontend development. Each project helps me strengthen my understanding of **HTML, CSS, JavaScript, DOM manipulation, browser APIs, Local Storage, and external APIs**.
...
| ⬇️ Download Simulation | Simulates a file download with a dynamic progress bar and percentage, then displays a completion message when the download reaches 100%. |
...
My focus is **understanding how things work**, writing the logic myself, debugging problems, and gradually taking on more challenging projects.
...
- Using timing functions like `setInterval()`
- Updating UI elements based on changing data
...
The projects aren't meant to be perfect. They represent my progress as I learn, experiment, debug, and gradually take on more challenging problems.
